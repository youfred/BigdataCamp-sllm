...
# DB 불러오기 및 검색기 생성
vectorstore = FAISS.load_local('./db1/faiss', embeddings=embeddings, allow_dangerous_deserialization=True)
...
You must add a line break at the end of each sentence.
You must output the result in a way that looks good.
